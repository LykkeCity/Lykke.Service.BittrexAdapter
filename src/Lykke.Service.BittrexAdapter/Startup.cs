...
namespace Lykke.Service.BittrexAdapter
{
    [UsedImplicitly]
    public class Startup
    {
        ...
        {                                   
            return services.BuildServiceProvider<AppSettings>(options =>
            {
                ...
                options.Logs = logs =>
                {
                    logs.AzureTableName = "BittrexAdapterLog";
                    logs.AzureTableConnectionStringResolver = settings => settings.BittrexAdapterService.Db.LogsConnString;
                    ...
                    logs.Extended = extendedLogs =>
                    {
                        ...
                        extendedLogs.AddAdditionalSlackChannel("BittrexAdapter", channelOptions =>
                        {
